...
export default class BeBriefed extends Component {
  constructor(props) {
    ...
    this._fetchServiceStatus = this._switchService.bind(this)
  ...
  render() {
    return (
      <MainContainer selectedService = {this.state.selectedService} services = {this.state.services} onServiceChange={this._switchService}/>
    );
  }
}
